...
if __name__ == "__main__":
    ...
    headers = ["URL", "Last Modification", "News Title", "News Publication Date", "News Name", "News Language", "News Text"]
    with open("sitemap_data_dhnet.csv", "w", newline="", encoding="utf-8") as csvfile:
        writer = csv.DictWriter(csvfile, fieldnames=headers)
        writer.writeheader()
        writer.writerows(sitemap_data_dhnet)
